...
namespace AiStudio4.Tools.YouTube
{
    [McpServerToolType]
    public class YouTubeSearchTool : BaseToolImplementation, IDisposable
    {
        ...
        public YouTubeSearchTool(ILogger<YouTubeSearchTool> logger, IGeneralSettingsService generalSettingsService, IStatusMessageService statusMessageService) 
