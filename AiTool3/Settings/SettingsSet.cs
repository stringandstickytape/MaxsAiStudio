...

    {
        ...
        private void Create()
        {
            ModelList = new List<Model>()
            {
                    ...
                    new Model { Url = "https://generativelanguage.googleapis.com/v1beta/models/", ServiceName = typeof(Gemini).Name, ModelName = "gemini-1.5-flash", Color = Color.FromArgb(186, 255, 216), input1MTokenPrice = .7m, output1MTokenPrice = 2.1m},
