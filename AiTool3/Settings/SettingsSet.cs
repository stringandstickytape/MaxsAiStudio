...
Analyze the above C# code and provide appropriate XML documentation comments for the code elements. Do not modify or repeat the original code; give only the comments to go above the relevant method or class. "
 ...
 new Model { Url = "https://api.openai.com/v1/chat/completions", ServiceName = typeof(OpenAI).Name, ModelName = "gpt-4o-mini", FriendlyName = "GPT-4o Mini", Color = Color.FromArgb(255, 179, 186), input1MTokenPrice = 5, output1MTokenPrice = 15},
...
new Model { Url = "https://generativelanguage.googleapis.com/v1beta/models/", ServiceName = typeof(Gemini).Name, ModelName = "gemini-exp-1206", FriendlyName = "Gemini Exp 1206", Color = Color.FromArgb(186, 255, 216), input1MTokenPrice = 0m, output1MTokenPrice = 0m},
new Model { Url = "https://generativelanguage.googleapis.com/v1beta/openai/", ServiceName = typeof(OpenAI).Name, ModelName = "gemini-exp-1206", FriendlyName = "Gemini Exp 1206 via OpenAI API", Color = Color.FromArgb(186, 255, 216), input1MTokenPrice = 0m, output1MTokenPrice = 0m},
