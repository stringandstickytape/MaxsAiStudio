...
namespace AiTool3.Helpers
{
    public static class SpecialsHelper
    {
        ...
        public static async Task<AiResponse> GetReadmeResponses(Model model)
        {
            ...
            var response = await aiService!.FetchResponse(model, conversation, null!, null!, new CancellationToken(false), null, mustNotUseEmbedding: true, toolIDs: null, useStreaming: false);
