// AiStudioClient/src/components/ui/unified-modal-dialog/UnifiedModalDialog.tsx
      ...
      <DialogPrimitive.Portal>
        ...
        <div className={cn('UnifiedModalDialog fixed inset-0 z-50 flex overflow-auto', positionClass)}>
          <DialogPrimitive.Content
            ...
            style={{
              backgroundColor: 'var(--unifiedmodaldialog-bg, var(--global-background-color, var(--background)))',
              color: 'var(--unifiedmodaldialog-text-color, var(--global-text-color, var(--foreground)))',
              borderColor: 'var(--unifiedmodaldialog-border-color, var(--global-border-color, var(--border)))',
              borderRadius: 'var(--unifiedmodaldialog-border-radius, var(--global-border-radius, 0.5rem))',
              boxShadow: 'var(--unifiedmodaldialog-box-shadow, var(--global-box-shadow, 0 10px 15px -3px rgba(0, 0, 0, 0.1), 0 4px 6px -2px rgba(0, 0, 0, 0.05)))',
              fontFamily: 'var(--unifiedmodaldialog-font-family, var(--global-font-family, inherit))',
              fontSize: 'var(--unifiedmodaldialog-font-size, var(--global-font-size, inherit))',
              animationDuration: `${animationDuration ?? 150}ms`,
              ...themeStyle
            }}
          >
