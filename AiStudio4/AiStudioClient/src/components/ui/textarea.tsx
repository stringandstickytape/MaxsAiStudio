  ...
  ({ className, showLineCount = true, ...props }, ref) => {
    ...
    return (
      <div className="relative h-full">
        ...
        <textarea
          className={cn(
            "flex min-h-[80px] w-full h-full px-3 py-2 text-sm ring-offset-background placeholder:text-gray-400 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50",
            className
          )}
          ref={handleRefs}
          {...props}
