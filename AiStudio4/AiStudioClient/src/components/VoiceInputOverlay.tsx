...
export const VoiceInputOverlay: React.FC<VoiceInputOverlayProps> = ({ isOpen, onClose, onTranscript }) => {
      ...
      <div className="bg-gray-900 border border-gray-700 rounded-lg p-6 shadow-2xl max-w-md w-full mx-4">
        ...
        {!isSupported ? (
          <div className="text-center py-6">
            ...
            <p className="text-gray-400 text-sm mt-2">Try using Chrome, Edge, or Safari on a mobile device.</p>
          </div>
        ) : (
          <>
            <div className="flex justify-center mb-6">
              <div
                className={cn(
                  ...
                  isListening ? 'border-blue-500 bg-blue-500/20 animate-pulse' : 'border-gray-700 bg-gray-800',
                )}
              >
                <Mic className={cn('h-8 w-8 transition-colors', isListening ? 'text-blue-500' : 'text-gray-400')} />
              </div>
            </div>
