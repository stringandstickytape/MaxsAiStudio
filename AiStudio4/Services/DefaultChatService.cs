...
namespace AiStudio4.Services
{
    public class DefaultChatService : IChatService
    {
        ...
        public DefaultChatService(ILogger<DefaultChatService> logger, SettingsManager settingsManager, IToolService toolService, ISystemPromptService systemPromptService, IMcpService mcpService)
        {
            _logger = logger;
