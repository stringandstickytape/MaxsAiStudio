...
""",
        ...
        [McpServerTool, Description("Retrieves pull requests matching specified criteria from an Azure DevOps repository.")]
        public async Task<string> AzureDevOpsGetPullRequests([Description("JSON parameters for AzureDevOpsGetPullRequests")] string parameters = "{}")
        {
