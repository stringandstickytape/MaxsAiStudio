...
import { fetchSystemPrompts, toggleLibrary, setCurrentPrompt } from '@/store/systemPromptSlice';
    ...
    commands: [
      {
        ...
        execute: () => {
          ...
          // Also make sure we have the latest prompts
          store.dispatch(fetchSystemPrompts());
        }
      },
      {
